    ...
    <header class="header">
        ...
        <nav class="navbar">
          <div class="navbar__logo">
            <img src="/sprint2/BRIEF_projet/images/logo.svg" alt="" class="navbar__img" />
          </div>
          <a href="" class="navbar__down"><i class="fas fa-bars"></i></a>
          <ul class="navbar__ul">
    ...
    <main class="main">
      ...
      <div class="menu">
        <!-- <div class="menu__card"> -->
          <?php 
            $sql_query_select = "SELECT * FROM products LIMIT 3 ";
            ...
            // for ($i=0; $i < 6; $i++) { 
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<div class="menu__card1--btn">';
                echo '<p class="menu__text">';
                echo '<span class="menu__price">'. $price_product .'</span><br>';
                echo '<span class="menu__name">'. $name_product. '</span>';
                 echo '</p>';
